...
$lang_module['headbook_id'] = 'Tên sổ đầu bài';
...
$lang_module['error_required_headbook_id'] = 'Lỗi: bạn cần nhập dữ liệu cho Tên sổ đầu bài';
...
$lang_module['error_required_subject_id'] = 'Lỗi: bạn cần nhập dữ liệu cho Môn học';
$lang_module['error_required_times_id'] = 'Lỗi: bạn cần nhập dữ liệu cho Tiết CT';
$lang_module['error_required_lesson_id'] = 'Lỗi: bạn cần nhập dữ liệu cho Bài';
...
$lang_module['error_required_teacher_id'] = 'Lỗi: bạn cần nhập dữ liệu cho Giáo viên';
