...
define('AUTHOR_FILEHEAD', "/**\n * @Project Tập Đoàn TMS Holdings\n * @Author " . $data_system['author_name'] . " <contact@tms.vn>\n * @Copyright (C) " . gmdate("Y") . " Tập Đoàn TMS Holdings. All rights reserved\n * @License GNU/GPL version 2 or any later version\n * @Createdate " . gmdate("D, d M Y H:i:s") . " GMT\n */");
...
if ((!empty($blocktheme) or preg_match('/^[a-zA-Z0-9\_\-]+$/', $modname)) and preg_match('/^[a-zA-Z0-9\_\-]+$/', $blockname)) {
    ...
    if ($blocksetting) {
        ...
        $ini_block_i .= "\t\t<author>Tập Đoàn TMS Holdings</author>\n";
